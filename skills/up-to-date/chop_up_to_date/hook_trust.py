...
Packaged entry point (`uv tool install ./skills/up-to-date/`):
    ...
    up-to-date-hook-trust --repo-toplevel <path> --pretty
    ...
    up-to-date-hook-trust --approve --repo-toplevel <path> \
...
def cli_main() -> None:
    """Console-script entry point. Wired via `[project.scripts] up-to-date-hook-trust = ...`."""
